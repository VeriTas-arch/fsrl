"""Non-Liu CUDA parity for both fixed evidence routes."""
...
from .inputs import check_pair, route_batch
...
def qualify_condition(spec: dict, condition: str) -> dict:
    ...
    routing_check = check_pair(cpu)
    batch = route_batch(cpu, condition).to("cuda")
