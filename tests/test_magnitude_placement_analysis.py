...
from fsrl.magnitude_placement_analysis import (
    PAIRS,
    adjusted_ols,
    analyze_profiles,
    classify_outcome,
...
from fsrl.magnitude_placement_collection import (
    PROTOCOL_PATH,
    READINESS_PATH,
    build_manifest,
...
class MagnitudePlacementAnalysisTests(unittest.TestCase):
    ...
    def test_hodge_rank_recovers_a_perfect_complete_order(self):
        order = list(reversed(self.protocol["inherited_frozen_contract"]["assignment_A_low_to_high"]))
