...
SPECIFICATION_PATH = ROOT / "benchmarks" / "dual_state_reduced_algorithm_v3.json"
IMPLEMENTATION_LOCK_PATH = ROOT / "benchmarks" / "dual_state_reduced_algorithm_v3.lock.json"
RESULT_PATH = ROOT / "results" / "dual_state_reduced_algorithm_v3.json"
...
def build_result(
    ...
    v2_result = load_json(ROOT / specification["registered_sources"]["v2_result"]["path"])
