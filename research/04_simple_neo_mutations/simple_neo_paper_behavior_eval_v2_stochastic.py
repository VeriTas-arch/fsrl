...
Critical safety/interpretation choices:
  ...
  6. Stochastic testing, when requested, samples from the model's own softmax
     policy with an explicit temperature. This is a diagnostic readout of model
     uncertainty, not a fitted noise term inserted to force human-like results.
"""
...
SCRIPT_VERSION = "simple_neo_paper_behavior_eval_2026-07-09_v2_stochastic"
