...
STUDY = "admission_hint_removal"
RECORDS = STUDIES_ROOT / STUDY / "records"
RUNS = RUNS_ROOT / "admission_hint_removal_v1"
...
PROTOCOL_SHA256 = "bec0b74bc04e6713d0efdd9f8b2d24c6c2d29cebd23bd3fed07fe9f229177d82"
...
def register(
    status="unresolved",
    finding="Prospective matched hint removal; new no-hint outcomes not evaluated.",
):
    values = {
        "schema_version": 1,
        "id": STUDY,
        "title": "Explicit admission-hint removal in a single-memory RNN",
        ...
        "finding": finding,
        "boundary": "Three matched A/C instances and exposed panels; zq hint removed with unchanged q and no local memory. No human confirmation or promotion.",
    }
