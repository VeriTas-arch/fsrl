"""
Standard full all-pair evaluation for simple_neo_mutants_v2 checkpoints.
...
SCRIPT_VERSION = "simple_neo_full28_eval_2026-07-09_v2_timefix"
...
def load_training_config(checkpoint_dir: Path) -> dict:
    ...
    if not text:
        return {}
    # simple_neo_mutants_v2 wrote a Python dict string rather than strict JSON.
    try:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Full 28-pair no-feedback evaluator for simple_neo_mutants_v2 checkpoints.")
