...
from .curvature_gate import make_gate_tasks
...
from .meta_train import MetaTrainConfig, build_meta_input_sequence
...
DEFAULT_OUTPUT_ROOT = (
    ROOT / "artifacts" / "runs" / "conjunctive-local-trace-pilot-v2-3"
)
