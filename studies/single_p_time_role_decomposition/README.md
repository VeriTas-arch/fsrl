# Frozen decomposition of normalized time in clean single-P

<!-- fsrl-doc role=generated-navigation source=studies/single_p_time_role_decomposition/study.toml -->

> [!NOTE]
> **Generated navigation.**
>
> - **Authority:** `studies/single_p_time_role_decomposition/study.toml`
...
**Question.** Is seed 3011's no-time Ce deficit scale-sufficient, where does explicit
...
- `noninterpretable_attempt` —
  [studies/single_p_time_role_decomposition/records/results/execution_attempt1.json](records/results/execution_attempt1.json)
  (`sha256:ccc2d906db88`)
- `repair_contract` —
  [studies/single_p_time_role_decomposition/records/benchmarks/single_p_time_role_decomposition_v1.repair5.json](records/benchmarks/single_p_time_role_decomposition_v1.repair5.json)
  (`sha256:cdbf6bcf64ee`)
- `validation_result` —
  [studies/single_p_time_role_decomposition/records/benchmarks/qualification_v4.json](records/benchmarks/qualification_v4.json)
  (`sha256:c6ca5aa47342`)
- `execution_lock` —
  [studies/single_p_time_role_decomposition/records/benchmarks/source_lock_v2.json](records/benchmarks/source_lock_v2.json)
  (`sha256:08c1012ca39f`)
- `noninterpretable_attempt` —
  [studies/single_p_time_role_decomposition/records/results/execution_attempt2.json](records/results/execution_attempt2.json)
  (`sha256:7ceb5865e89f`)
- `repair_contract` —
  [studies/single_p_time_role_decomposition/records/benchmarks/single_p_time_role_decomposition_v1.repair6.json](records/benchmarks/single_p_time_role_decomposition_v1.repair6.json)
  (`sha256:b8a0e1f29e6e`)
- `validation_result` —
  [studies/single_p_time_role_decomposition/records/benchmarks/qualification_v5.json](records/benchmarks/qualification_v5.json)
  (`sha256:abb7b39f4157`)
- `execution_lock` —
