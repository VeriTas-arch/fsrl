...
<!-- fsrl-doc role=generated-navigation source=studies/support_factor_swap/study.toml -->

> [!NOTE]
> **Generated navigation.**
>
> - **Authority:** `studies/support_factor_swap/study.toml`
...
**Question.** Are eligibility direction and DA-linked magnitude causally transferable
factors of support writing?
...
**Claim boundary.** One formal seed later showed DA-direction heterogeneity, so
direction preservation is not a universal implementation invariant.

## Frozen records

- `registered_contract` —
  [benchmarks/support_factor_swap_v1.json](records/benchmarks/support_factor_swap_v1.json)
  (`sha256:4a447d96cc02`)
- `report` — [docs/support_factor_swap_v1.md](records/docs/support_factor_swap_v1.md)
  (`sha256:a03ed04308c6`)
- `frozen_result` —
  [results/support_factor_swap_v1.json](records/results/support_factor_swap_v1.json)
  (`sha256:14344c656185`)
