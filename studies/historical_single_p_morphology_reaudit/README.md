...
<!-- fsrl-doc role=generated-navigation source=studies/historical_single_p_morphology_reaudit/study.toml -->

> [!NOTE]
> **Generated navigation.**
>
> - **Authority:** `studies/historical_single_p_morphology_reaudit/study.toml`
...
**Question.** Did either frozen historical alpha-bearing single-P family already satisfy
...
geometry without training, checkpoint loading, model inference, rescaling, threshold
search, selection, historical-record mutation, or main-model promotion.
...
- `repair_contract` —
  ...
  (`sha256:ce96dc7ce224`)
- `repair_contract` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/implementation_repair2.json](records/benchmarks/implementation_repair2.json)
  (`sha256:7f996a479214`)
- `repair_contract` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/implementation_repair3.json](records/benchmarks/implementation_repair3.json)
  (`sha256:672c2037aa39`)
- `validation_result` —
  ...
  (`sha256:1ff62f78d9ec`)
- `validation_result` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/qualification_repair1.json](records/benchmarks/qualification_repair1.json)
  (`sha256:2e4cd36da34f`)
- `validation_result` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/qualification_repair2.json](records/benchmarks/qualification_repair2.json)
  (`sha256:ac22d4bce49e`)
- `validation_result` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/qualification_repair3.json](records/benchmarks/qualification_repair3.json)
  (`sha256:3e5eff0c18ed`)
- `execution_lock` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/source_input_lock.json](records/benchmarks/source_input_lock.json)
  (`sha256:c833eff36ee7`)
- `execution_lock` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/source_input_lock_repair1.json](records/benchmarks/source_input_lock_repair1.json)
  (`sha256:4bf88e52ee2b`)
- `execution_lock` —
  [studies/historical_single_p_morphology_reaudit/records/benchmarks/source_input_lock_repair2.json](records/benchmarks/source_input_lock_repair2.json)
  (`sha256:cd5e7591876b`)
