"""Zero-hint numerical qualification and archived single-memory collector parity."""
...
def numerical_checks(device="cpu", compiled=False):
    ...
    assert torch.count_nonzero(net.i2h.weight.grad[:, 34]) == 0
...
def qualify():
    ...
    with ProspectiveRun.start(
        ...
        execution_id="hint-mask-qualification",
