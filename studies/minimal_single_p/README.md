# Subtractive simplification of the clean single-P learner

<!-- fsrl-doc role=generated-navigation source=studies/minimal_single_p/study.toml -->

> [!NOTE]
> **Generated navigation.**
>
> - **Authority:** `studies/minimal_single_p/study.toml`
...
**Question.** How far can the clean no-time single-P recurrent learner be simplified in
...
- `report` —
  ...
  (`sha256:a06d525a1952`)
- `artifact_lock` —
  [studies/minimal_single_p/records/benchmarks/model_lock.M2.json](records/benchmarks/model_lock.M2.json)
  (`sha256:e2cb76063eb1`)
- `frozen_result` —
  [studies/minimal_single_p/records/results/minimal_single_p_v1.M2.json](records/results/minimal_single_p_v1.M2.json)
  (`sha256:4054c5cfbf2d`)
- `report` —
