...
STUDY = "local_memory_removal"
RECORDS = STUDIES_ROOT / STUDY / "records"
RUNS = RUNS_ROOT / "local_memory_removal_v1"
...
PROTOCOL_SHA256 = "bda917f0c28be7e9bf6c0a3be321d81399d838fd425a5feed236d924ea249ffd"
...
def register(
    ...
    values = {
        "schema_version": 1,
        "id": STUDY,
        "title": "Local-memory removal under observation uncertainty",
        ...
        "finding": finding,
        "boundary": "Three matched A/C instances, exposed dual references and panels; local memory removed during training, no human confirmation or promotion.",
    }
