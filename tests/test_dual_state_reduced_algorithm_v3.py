...
from fsrl import dual_state_reduced_algorithm_v2 as v2
from fsrl.dual_state_reduced_algorithm import EpisodeTrajectory
from fsrl.dual_state_reduced_algorithm_v3 import (
...
class ItemHistoryReducedAlgorithmTests(unittest.TestCase):
    ...
    def test_fit_recovers_item_history_transition(self):
        ...
        np.testing.assert_allclose(
            item_history_rollout(test, fitted), item_history_rollout(test, true), atol=2e-9
        )
