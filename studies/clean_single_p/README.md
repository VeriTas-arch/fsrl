# Direct training of the cleaned single-P affine RNN

<!-- fsrl-doc role=generated-navigation source=studies/clean_single_p/study.toml -->

> [!NOTE]
> **Generated navigation.**
>
> - **Authority:** `studies/clean_single_p/study.toml`
...
**Question.** Can a directly trained single-P affine plastic RNN remove the legacy
input, output, time, value-head, local-memory, and blank-step scaffolding while
