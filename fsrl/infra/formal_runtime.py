...
WORKFLOW_MODULES = {
    ...
    "observation-uncertainty": "fsrl.experiments.observation_uncertainty.__main__",
    "finite-state-memory": "fsrl.experiments.finite_state.__main__",
    ...
    "pl-functional-replication": (
        "fsrl.experiments.pl_direct_training.functional_replication.__main__"
    ),
    "pl-crosstalk-decomposition": (
        "fsrl.experiments.pl_crosstalk_decomposition.__main__"
    ),
    "clean-single-p": "fsrl.experiments.clean_single_p.__main__",
    "single-p-time-role": "fsrl.experiments.single_p_time_role.__main__",
    ...
    "single-p-anytime": "fsrl.experiments.single_p_anytime.__main__",
    "minimal-single-p": "fsrl.experiments.minimal_single_p.__main__",
