...
DEFAULT_SPECIFICATION_PATH = resolve_record(
    "benchmarks/global_policy_comparator_adequacy_v1.json"
)
DEFAULT_IMPLEMENTATION_LOCK_PATH = resolve_record(
    "benchmarks/global_policy_comparator_adequacy_v1.lock.json"
)
DEFAULT_PROTOCOL_REPAIR_PATH = resolve_record(
    "benchmarks/global_policy_comparator_adequacy_v1.repair1.json"
)
DEFAULT_RESULT_PATH = resolve_record(
    "results/global_policy_comparator_adequacy_v1.json"
)
